...
import { TEMPLATE_DAYHOURS_ACTIVITY } from 'lib/constants/visualise';
...
const buildModel = model =>
  model
    .set('type', TEMPLATE_DAYHOURS_ACTIVITY)
    .set('description', description)
    .set('axesgroup', new Map({ optionKey: 'hour', searchString: 'Hour' }))
